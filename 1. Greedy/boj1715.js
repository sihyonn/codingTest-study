  ...
  bubbleUp() {
    ...
    while (currentIdx > 0) {
      ...
      if (this.data[currentIdx] < this.data[parentIdx]) {
        [this.data[parentIdx], this.data[currentIdx]] = [this.data[currentIdx], this.data[parentIdx]]
    ...
    while (true) {
      ...
      if (leftChild <= rightChild) {
        if (this.data[currentIdx] > leftChild) {
          [this.data[currentIdx], this.data[currentIdx * 2 + 1]] = [this.data[currentIdx * 2 + 1], this.data[currentIdx]]
          currentIdx = currentIdx * 2 + 1
        }
        else if (this.data[currentIdx] > rightChild) {

          [this.data[currentIdx], this.data[currentIdx * 2 + 2]] = [this.data[currentIdx * 2 + 2], this.data[currentIdx]]
